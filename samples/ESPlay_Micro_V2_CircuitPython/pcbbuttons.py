...
class KeyPad(dict):
    ...
    def __init__(self, debounce):
        ...
        import busio
        i2c = busio.I2C(board.IO22, board.IO21)  # ESPLay
        ...
        self[self.BTN_UP]=PCFKeyHandle(pcf.get_pin(2),True)
        self[self.BTN_DOWN]=PCFKeyHandle(pcf.get_pin(3),True)
        self[self.BTN_SELECT]=PCFKeyHandle(pcf.get_pin(5),True)
        self[self.BTN_MENU]=PCFKeyHandle(pcf.get_pin(4),True)
